 ...
 */
@Singleton
public class WakeServlet extends BaseServlet {
    static final Logger LOG = Logger.getLogger(WakeServlet.class.getName());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        issue(MIME_TEXT_PLAIN, HTTP_STATUS_OK, "ok", response);
    }
